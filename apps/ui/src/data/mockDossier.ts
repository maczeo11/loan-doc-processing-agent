...
export const DEMO_DOSSIER_APP_25195: LoanApplicationState = {
  ...
  applicant: {
    ...
    source_name: {
      ...
      bounding_box: { x0: 0.15, y0: 0.22, x1: 0.52, y1: 0.28 },
    },
    source_pan: {
      document_id: 'doc-pan-card',
      document_type: 'id_card',
      ...
      bounding_box: { x0: 0.15, y0: 0.35, x1: 0.48, y1: 0.40 },
    },
  },
  payslip: {
    ...
    net_salary: {
      ...
      source: {
        ...
        bounding_box: { x0: 0.65, y0: 0.78, x1: 0.88, y1: 0.82 },
      },
    },
  ...
  bank_statement: {
    ...
    salary_credits: [
      {
        ...
        source: {
          ...
          bounding_box: { x0: 0.12, y0: 0.34, x1: 0.78, y1: 0.38 },
        },
      },
    ],
    average_salary_credit: {
      ...
      source: {
        ...
        bounding_box: { x0: 0.50, y0: 0.80, x1: 0.85, y1: 0.84 },
      },
    },
    closing_balance: {
      amount: 145000,
  ...
  tax_return: {
    ...
    gross_total_income: {
      ...
      source: {
        ...
        bounding_box: { x0: 0.55, y0: 0.45, x1: 0.85, y1: 0.49 },
      },
    },
    total_tax_paid: {
      amount: 78000,
      ...
      source: {
        ...
        bounding_box: { x0: 0.55, y0: 0.62, x1: 0.85, y1: 0.66 },
      },
    },
  },
  findings: [
