      ...
      citations: [
        {
          ...
          bounding_box: { x0: 0.08, y0: 0.72, x1: 0.50, y1: 0.82 },
          confidence: 0.99,
        ...
        },
        {
          ...
          bounding_box: { x0: 0.08, y0: 0.28, x1: 0.92, y1: 0.38 },
          confidence: 0.98,
          extraction_method: 'pymupdf_native',
        },
        {
      ...
      citations: [
        {
          ...
          bounding_box: { x0: 0.08, y0: 0.44, x1: 0.65, y1: 0.54 },
          confidence: 0.99,
          extraction_method: 'pymupdf_native',
        },
        {
          ...
          bounding_box: { x0: 0.65, y0: 0.42, x1: 0.88, y1: 0.46 },
          confidence: 0.99,
          extraction_method: 'pymupdf_native',
        },
      ],
      ...
      citations: [
        {
          ...
          bounding_box: { x0: 0.08, y0: 0.22, x1: 0.85, y1: 0.32 },
          confidence: 0.99,
          extraction_method: 'pymupdf_native',
        },
      ],
      ...
      citations: [
        {
          ...
          bounding_box: { x0: 0.60, y0: 0.88, x1: 0.90, y1: 0.92 },
          confidence: 0.97,
          extraction_method: 'pymupdf_native',
        },
      ],
